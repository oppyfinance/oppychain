...
export class QueryClientImpl implements Query {
  ...
  ModuleBalance(request: ModuleBalanceRequest): Promise<ModuleBalanceResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "ModuleBalance", data);
  ...
  ModuleLockedAmount(request: ModuleLockedAmountRequest): Promise<ModuleLockedAmountResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "ModuleLockedAmount", data);
  ...
  AccountUnlockableCoins(request: AccountUnlockableCoinsRequest): Promise<AccountUnlockableCoinsResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountUnlockableCoins", data);
  ...
  AccountUnlockingCoins(request: AccountUnlockingCoinsRequest): Promise<AccountUnlockingCoinsResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountUnlockingCoins", data);
  ...
  AccountLockedCoins(request: AccountLockedCoinsRequest): Promise<AccountLockedCoinsResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountLockedCoins", data);
  ...
  AccountLockedPastTime(request: AccountLockedPastTimeRequest): Promise<AccountLockedPastTimeResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountLockedPastTime", data);
  ...
  AccountUnlockedBeforeTime(request: AccountUnlockedBeforeTimeRequest): Promise<AccountUnlockedBeforeTimeResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountUnlockedBeforeTime", data);
  ...
  AccountLockedPastTimeDenom(request: AccountLockedPastTimeDenomRequest): Promise<AccountLockedPastTimeDenomResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountLockedPastTimeDenom", data);
  ...
  LockedDenom(request: LockedDenomRequest): Promise<LockedDenomResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "LockedDenom", data);
    return promise.then((data) => LockedDenomResponse.decode(new _m0.Reader(data)));
  }

  LockedByID(request: LockedRequest): Promise<LockedResponse> {
    const data = LockedRequest.encode(request).finish();
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "LockedByID", data);
  ...
  SyntheticLockupsByLockupID(request: SyntheticLockupsByLockupIDRequest): Promise<SyntheticLockupsByLockupIDResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "SyntheticLockupsByLockupID", data);
  ...
  AccountLockedLongerDuration(
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountLockedLongerDuration", data);
  ...
  AccountLockedDuration(request: AccountLockedDurationRequest): Promise<AccountLockedDurationResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountLockedDuration", data);
  ...
  AccountLockedLongerDurationDenom(
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.lockup.Query", "AccountLockedLongerDurationDenom", data);
