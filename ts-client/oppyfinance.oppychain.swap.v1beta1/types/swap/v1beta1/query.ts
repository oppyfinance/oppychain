...
export class QueryClientImpl implements Query {
  ...
  Pools(request: QueryPoolsRequest): Promise<QueryPoolsResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "Pools", data);
  ...
  NumPools(request: QueryNumPoolsRequest): Promise<QueryNumPoolsResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "NumPools", data);
  ...
  TotalLiquidity(request: QueryTotalLiquidityRequest): Promise<QueryTotalLiquidityResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "TotalLiquidity", data);
    return promise.then((data) => QueryTotalLiquidityResponse.decode(new _m0.Reader(data)));
  }

  Pool(request: QueryPoolRequest): Promise<QueryPoolResponse> {
    const data = QueryPoolRequest.encode(request).finish();
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "Pool", data);
  ...
  PoolParams(request: QueryPoolParamsRequest): Promise<QueryPoolParamsResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "PoolParams", data);
  ...
  TotalPoolLiquidity(request: QueryTotalPoolLiquidityRequest): Promise<QueryTotalPoolLiquidityResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "TotalPoolLiquidity", data);
  ...
  TotalShares(request: QueryTotalSharesRequest): Promise<QueryTotalSharesResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "TotalShares", data);
  ...
  SpotPrice(request: QuerySpotPriceRequest): Promise<QuerySpotPriceResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "SpotPrice", data);
  ...
  EstimateSwapExactAmountIn(request: QuerySwapExactAmountInRequest): Promise<QuerySwapExactAmountInResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "EstimateSwapExactAmountIn", data);
  ...
  EstimateSwapExactAmountOut(request: QuerySwapExactAmountOutRequest): Promise<QuerySwapExactAmountOutResponse> {
    ...
    const promise = this.rpc.request("oppyfinance.oppychain.swap.v1beta1.Query", "EstimateSwapExactAmountOut", data);
