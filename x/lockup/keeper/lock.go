...
func (k Keeper) removeTokensFromLock(ctx sdk.Context, lock *types.PeriodLock, coins sdk.Coins) error {
	// TODO: Handle 100% slash eventually, not needed for oppy codebase atm.
...
func (k Keeper) BreakAllSyntheticLocks(ctx sdk.Context, lock types.PeriodLock, synthLocks []types.SyntheticLock) error {
	...
	// see that [CreateSyntheticLock](https://github.com/oppy-labs/oppy/blob/v7.3.0/x/lockup/keeper/synthetic_lock.go#L105)
	...
	// https://github.com/oppy-labs/oppy/blob/v7.3.0/x/lockup/keeper/synthetic_lock.go#L156
	for _, synthLock := range synthLocks {
