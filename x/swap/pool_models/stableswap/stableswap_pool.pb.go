...
// source: swap/pool_models/stableswap/stableswap_pool.proto
...
func (*PoolParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_90a0d762b7a0e14d, []int{0}
}
...
func (*Pool) Descriptor() ([]byte, []int) {
	return fileDescriptor_90a0d762b7a0e14d, []int{1}
}
...
func init() {
	proto.RegisterType((*PoolParams)(nil), "oppyfinance.oppychain.swap.stableswap.v1beta1.PoolParams")
	proto.RegisterType((*Pool)(nil), "oppyfinance.oppychain.swap.stableswap.v1beta1.Pool")
}

func init() {
	proto.RegisterFile("swap/pool_models/stableswap/stableswap_pool.proto", fileDescriptor_90a0d762b7a0e14d)
}

var fileDescriptor_90a0d762b7a0e14d = []byte{
	// 627 bytes of a gzipped FileDescriptorProto
	,
}
