...
func TestPoolProtoMarshal(t *testing.T) {
	...
	decodedByteArray, err := hex.DecodeString("")
	require.NoError(t, err)
	...
	require.Equal(t, pool2.TotalShares, sdk.Coin{Denom: "swap/pool/10", Amount: sdk.ZeroInt()})
	pool2.TotalShares = sdk.Coin{Denom: "swap/pool/10", Amount: sdk.ZeroInt()}
