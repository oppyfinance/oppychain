...
import { PeriodLock } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.lockup/types"
import { QueryCondition } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.lockup/types"
import { SyntheticLock } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.lockup/types"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: oppyfinance.oppychain.lockup initialized!')
		...
		async QueryModuleBalance({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				let value= (await client.OppyfinanceOppychainLockup.query.queryModuleBalance()).data
		...
		async QueryModuleLockedAmount({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryModuleLockedAmount()).data
		...
		async QueryAccountUnlockableCoins({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountUnlockableCoins( key.owner)).data
		...
		async QueryAccountUnlockingCoins({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountUnlockingCoins( key.owner)).data
		...
		async QueryAccountLockedCoins({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedCoins( key.owner)).data
		...
		async QueryAccountLockedPastTime({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedPastTime( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountLockedPastTime( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
		...
		async QueryAccountLockedPastTimeNotUnlockingOnly({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedPastTimeNotUnlockingOnly( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountLockedPastTimeNotUnlockingOnly( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryAccountUnlockedBeforeTime({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountUnlockedBeforeTime( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountUnlockedBeforeTime( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryAccountLockedPastTimeDenom({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedPastTimeDenom( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountLockedPastTimeDenom( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryLockedDenom({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryLockedDenom(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryLockedDenom({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryLockedByID({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryLockedById( key.lock_id)).data
		...
		async QuerySyntheticLockupsByLockupID({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.querySyntheticLockupsByLockupId( key.lock_id)).data
		...
		async QueryAccountLockedLongerDuration({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedLongerDuration( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountLockedLongerDuration( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryAccountLockedDuration({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedDuration( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountLockedDuration( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryAccountLockedLongerDurationNotUnlockingOnly({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedLongerDurationNotUnlockingOnly( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountLockedLongerDurationNotUnlockingOnly( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async QueryAccountLockedLongerDurationDenom({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainLockup.query.queryAccountLockedLongerDurationDenom( key.owner, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.OppyfinanceOppychainLockup.query.queryAccountLockedLongerDurationDenom( key.owner, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
		...
		async sendMsgLockTokens({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				...
				const result = await client.OppyfinanceOppychainLockup.tx.sendMsgLockTokens({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
		...
		async sendMsgBeginUnlockingAll({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.OppyfinanceOppychainLockup.tx.sendMsgBeginUnlockingAll({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgBeginUnlocking({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.OppyfinanceOppychainLockup.tx.sendMsgBeginUnlocking({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgExtendLockup({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.OppyfinanceOppychainLockup.tx.sendMsgExtendLockup({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async MsgLockTokens({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.OppyfinanceOppychainLockup.tx.msgLockTokens({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgLockTokens:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgBeginUnlockingAll({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.OppyfinanceOppychainLockup.tx.msgBeginUnlockingAll({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgBeginUnlockingAll:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgBeginUnlocking({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.OppyfinanceOppychainLockup.tx.msgBeginUnlocking({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgBeginUnlocking:Init Could not initialize signing client. Wallet is required.')
		...
		async MsgExtendLockup({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.OppyfinanceOppychainLockup.tx.msgExtendLockup({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgExtendLockup:Init Could not initialize signing client. Wallet is required.')
