...
import { Params } from "../../tokenfactory/v1beta1/params";
import { DenomAuthorityMetadata } from "../../tokenfactory/v1beta1/authorityMetadata";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request(
      "oppyfinance.oppychain.tokenfactory.v1beta1.Query",
      "Params",
      data
    );
