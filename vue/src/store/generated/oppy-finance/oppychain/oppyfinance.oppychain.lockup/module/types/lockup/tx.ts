...
export const MsgLockTokensResponse = {
  ...
  fromPartial(
    object: DeepPartial<MsgLockTokensResponse>
...
export const MsgBeginUnlockingAllResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgBeginUnlockingAllResponse,
    } as MsgBeginUnlockingAllResponse;
    message.unlocks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<MsgBeginUnlockingAllResponse>
  ): MsgBeginUnlockingAllResponse {
    const message = {
      ...baseMsgBeginUnlockingAllResponse,
    } as MsgBeginUnlockingAllResponse;
...
export const MsgBeginUnlockingResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgBeginUnlockingResponse,
    } as MsgBeginUnlockingResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgBeginUnlockingResponse>
  ): MsgBeginUnlockingResponse {
    const message = {
      ...baseMsgBeginUnlockingResponse,
    } as MsgBeginUnlockingResponse;
...
export class MsgClientImpl implements Msg {
  ...
  LockTokens(request: MsgLockTokens): Promise<MsgLockTokensResponse> {
    ...
    return promise.then((data) =>
      MsgLockTokensResponse.decode(new Reader(data))
    );
  }
  ...
  BeginUnlockingAll(
    ...
    return promise.then((data) =>
      MsgBeginUnlockingAllResponse.decode(new Reader(data))
    );
  }
