...
export const QueryCondition = {
  ...
  toJSON(message: QueryCondition): unknown {
    const obj: any = {};
    message.lock_query_type !== undefined &&
      (obj.lock_query_type = lockQueryTypeToJSON(message.lock_query_type));
...
export const SyntheticLock = {
  ...
  toJSON(message: SyntheticLock): unknown {
    const obj: any = {};
    message.underlying_lock_id !== undefined &&
      (obj.underlying_lock_id = message.underlying_lock_id);
    message.synth_denom !== undefined &&
