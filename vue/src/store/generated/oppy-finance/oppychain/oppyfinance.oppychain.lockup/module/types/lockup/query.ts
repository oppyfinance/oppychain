...
export const ModuleBalanceResponse = {
  ...
  fromPartial(
    object: DeepPartial<ModuleBalanceResponse>
...
export const ModuleLockedAmountRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseModuleLockedAmountRequest,
    } as ModuleLockedAmountRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<ModuleLockedAmountRequest>
  ): ModuleLockedAmountRequest {
    const message = {
      ...baseModuleLockedAmountRequest,
    } as ModuleLockedAmountRequest;
...
export const ModuleLockedAmountResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseModuleLockedAmountResponse,
    } as ModuleLockedAmountResponse;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<ModuleLockedAmountResponse>
  ): ModuleLockedAmountResponse {
    const message = {
      ...baseModuleLockedAmountResponse,
    } as ModuleLockedAmountResponse;
...
export const AccountUnlockableCoinsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountUnlockableCoinsRequest,
    } as AccountUnlockableCoinsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountUnlockableCoinsRequest>
  ): AccountUnlockableCoinsRequest {
    const message = {
      ...baseAccountUnlockableCoinsRequest,
    } as AccountUnlockableCoinsRequest;
...
export const AccountUnlockableCoinsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountUnlockableCoinsResponse,
    } as AccountUnlockableCoinsResponse;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountUnlockableCoinsResponse>
  ): AccountUnlockableCoinsResponse {
    const message = {
      ...baseAccountUnlockableCoinsResponse,
    } as AccountUnlockableCoinsResponse;
...
export const AccountUnlockingCoinsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountUnlockingCoinsRequest,
    } as AccountUnlockingCoinsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountUnlockingCoinsRequest>
  ): AccountUnlockingCoinsRequest {
    const message = {
      ...baseAccountUnlockingCoinsRequest,
    } as AccountUnlockingCoinsRequest;
...
export const AccountUnlockingCoinsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountUnlockingCoinsResponse,
    } as AccountUnlockingCoinsResponse;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountUnlockingCoinsResponse>
  ): AccountUnlockingCoinsResponse {
    const message = {
      ...baseAccountUnlockingCoinsResponse,
    } as AccountUnlockingCoinsResponse;
...
export const AccountLockedCoinsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedCoinsRequest,
    } as AccountLockedCoinsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountLockedCoinsRequest>
  ): AccountLockedCoinsRequest {
    const message = {
      ...baseAccountLockedCoinsRequest,
    } as AccountLockedCoinsRequest;
...
export const AccountLockedCoinsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedCoinsResponse,
    } as AccountLockedCoinsResponse;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountLockedCoinsResponse>
  ): AccountLockedCoinsResponse {
    const message = {
      ...baseAccountLockedCoinsResponse,
    } as AccountLockedCoinsResponse;
...
export const AccountLockedPastTimeRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedPastTimeRequest,
    } as AccountLockedPastTimeRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountLockedPastTimeRequest>
  ): AccountLockedPastTimeRequest {
    const message = {
      ...baseAccountLockedPastTimeRequest,
    } as AccountLockedPastTimeRequest;
...
export const AccountLockedPastTimeResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedPastTimeResponse,
    } as AccountLockedPastTimeResponse;
    message.locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountLockedPastTimeResponse>
  ): AccountLockedPastTimeResponse {
    const message = {
      ...baseAccountLockedPastTimeResponse,
    } as AccountLockedPastTimeResponse;
...
export const AccountLockedPastTimeNotUnlockingOnlyRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedPastTimeNotUnlockingOnlyRequest,
    } as AccountLockedPastTimeNotUnlockingOnlyRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountLockedPastTimeNotUnlockingOnlyRequest>
  ): AccountLockedPastTimeNotUnlockingOnlyRequest {
    const message = {
      ...baseAccountLockedPastTimeNotUnlockingOnlyRequest,
    } as AccountLockedPastTimeNotUnlockingOnlyRequest;
...
export const AccountLockedPastTimeNotUnlockingOnlyResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedPastTimeNotUnlockingOnlyResponse,
    } as AccountLockedPastTimeNotUnlockingOnlyResponse;
    message.locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountLockedPastTimeNotUnlockingOnlyResponse>
  ): AccountLockedPastTimeNotUnlockingOnlyResponse {
    const message = {
      ...baseAccountLockedPastTimeNotUnlockingOnlyResponse,
    } as AccountLockedPastTimeNotUnlockingOnlyResponse;
...
export const AccountUnlockedBeforeTimeRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountUnlockedBeforeTimeRequest,
    } as AccountUnlockedBeforeTimeRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountUnlockedBeforeTimeRequest>
  ): AccountUnlockedBeforeTimeRequest {
    const message = {
      ...baseAccountUnlockedBeforeTimeRequest,
    } as AccountUnlockedBeforeTimeRequest;
...
export const AccountUnlockedBeforeTimeResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountUnlockedBeforeTimeResponse,
    } as AccountUnlockedBeforeTimeResponse;
    message.locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountUnlockedBeforeTimeResponse>
  ): AccountUnlockedBeforeTimeResponse {
    const message = {
      ...baseAccountUnlockedBeforeTimeResponse,
    } as AccountUnlockedBeforeTimeResponse;
...
export const AccountLockedPastTimeDenomRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedPastTimeDenomRequest,
    } as AccountLockedPastTimeDenomRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountLockedPastTimeDenomRequest>
  ): AccountLockedPastTimeDenomRequest {
    const message = {
      ...baseAccountLockedPastTimeDenomRequest,
    } as AccountLockedPastTimeDenomRequest;
...
export const AccountLockedPastTimeDenomResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedPastTimeDenomResponse,
    } as AccountLockedPastTimeDenomResponse;
    message.locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountLockedPastTimeDenomResponse>
  ): AccountLockedPastTimeDenomResponse {
    const message = {
      ...baseAccountLockedPastTimeDenomResponse,
    } as AccountLockedPastTimeDenomResponse;
...
export const SyntheticLockupsByLockupIDRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSyntheticLockupsByLockupIDRequest,
    } as SyntheticLockupsByLockupIDRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<SyntheticLockupsByLockupIDRequest>
  ): SyntheticLockupsByLockupIDRequest {
    const message = {
      ...baseSyntheticLockupsByLockupIDRequest,
    } as SyntheticLockupsByLockupIDRequest;
...
export const SyntheticLockupsByLockupIDResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSyntheticLockupsByLockupIDResponse,
    } as SyntheticLockupsByLockupIDResponse;
    message.synthetic_locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.synthetic_locks.push(
  ...
  fromJSON(object: any): SyntheticLockupsByLockupIDResponse {
    ...
    message.synthetic_locks = [];
    if (
      object.synthetic_locks !== undefined &&
      object.synthetic_locks !== null
    ) {
  ...
  toJSON(message: SyntheticLockupsByLockupIDResponse): unknown {
    ...
    if (message.synthetic_locks) {
      obj.synthetic_locks = message.synthetic_locks.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<SyntheticLockupsByLockupIDResponse>
  ): SyntheticLockupsByLockupIDResponse {
    const message = {
      ...baseSyntheticLockupsByLockupIDResponse,
    } as SyntheticLockupsByLockupIDResponse;
...
export const AccountLockedLongerDurationRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedLongerDurationRequest,
    } as AccountLockedLongerDurationRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountLockedLongerDurationRequest>
  ): AccountLockedLongerDurationRequest {
    const message = {
      ...baseAccountLockedLongerDurationRequest,
    } as AccountLockedLongerDurationRequest;
...
export const AccountLockedLongerDurationResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedLongerDurationResponse,
    } as AccountLockedLongerDurationResponse;
    message.locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountLockedLongerDurationResponse>
  ): AccountLockedLongerDurationResponse {
    const message = {
      ...baseAccountLockedLongerDurationResponse,
    } as AccountLockedLongerDurationResponse;
...
export const AccountLockedLongerDurationNotUnlockingOnlyRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedLongerDurationNotUnlockingOnlyRequest,
    } as AccountLockedLongerDurationNotUnlockingOnlyRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountLockedLongerDurationNotUnlockingOnlyRequest>
  ): AccountLockedLongerDurationNotUnlockingOnlyRequest {
    const message = {
      ...baseAccountLockedLongerDurationNotUnlockingOnlyRequest,
    } as AccountLockedLongerDurationNotUnlockingOnlyRequest;
...
export const AccountLockedLongerDurationNotUnlockingOnlyResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedLongerDurationNotUnlockingOnlyResponse,
    } as AccountLockedLongerDurationNotUnlockingOnlyResponse;
    message.locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountLockedLongerDurationNotUnlockingOnlyResponse>
  ): AccountLockedLongerDurationNotUnlockingOnlyResponse {
    const message = {
      ...baseAccountLockedLongerDurationNotUnlockingOnlyResponse,
    } as AccountLockedLongerDurationNotUnlockingOnlyResponse;
...
const baseAccountLockedLongerDurationDenomRequest: object = {
  owner: "",
  denom: "",
};
...
export const AccountLockedLongerDurationDenomRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedLongerDurationDenomRequest,
    } as AccountLockedLongerDurationDenomRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<AccountLockedLongerDurationDenomRequest>
  ): AccountLockedLongerDurationDenomRequest {
    const message = {
      ...baseAccountLockedLongerDurationDenomRequest,
    } as AccountLockedLongerDurationDenomRequest;
...
export const AccountLockedLongerDurationDenomResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseAccountLockedLongerDurationDenomResponse,
    } as AccountLockedLongerDurationDenomResponse;
    message.locks = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<AccountLockedLongerDurationDenomResponse>
  ): AccountLockedLongerDurationDenomResponse {
    const message = {
      ...baseAccountLockedLongerDurationDenomResponse,
    } as AccountLockedLongerDurationDenomResponse;
...
export class QueryClientImpl implements Query {
  ...
  ModuleBalance(request: ModuleBalanceRequest): Promise<ModuleBalanceResponse> {
    ...
    return promise.then((data) =>
      ModuleBalanceResponse.decode(new Reader(data))
    );
  }
  ...
  ModuleLockedAmount(
    ...
    return promise.then((data) =>
      ModuleLockedAmountResponse.decode(new Reader(data))
    );
  }
  ...
  AccountUnlockableCoins(
    ...
    return promise.then((data) =>
      AccountUnlockableCoinsResponse.decode(new Reader(data))
    );
  }
  ...
  AccountUnlockingCoins(
    ...
    return promise.then((data) =>
      AccountUnlockingCoinsResponse.decode(new Reader(data))
    );
  }
  ...
  AccountLockedCoins(
    ...
    return promise.then((data) =>
      AccountLockedCoinsResponse.decode(new Reader(data))
    );
  }
  ...
  AccountLockedPastTime(
    ...
    return promise.then((data) =>
      AccountLockedPastTimeResponse.decode(new Reader(data))
    );
  }
  ...
  AccountLockedPastTimeNotUnlockingOnly(
    ...
    const data = AccountLockedPastTimeNotUnlockingOnlyRequest.encode(
      request
    ).finish();
    const promise = this.rpc.request(
      "oppyfinance.oppychain.lockup.Query",
    ...
    return promise.then((data) =>
      AccountLockedPastTimeNotUnlockingOnlyResponse.decode(new Reader(data))
    );
  }
  ...
  AccountUnlockedBeforeTime(
    ...
    return promise.then((data) =>
      AccountUnlockedBeforeTimeResponse.decode(new Reader(data))
    );
  }
  ...
  AccountLockedPastTimeDenom(
    ...
    return promise.then((data) =>
      AccountLockedPastTimeDenomResponse.decode(new Reader(data))
    );
  }
  ...
  SyntheticLockupsByLockupID(
    ...
    return promise.then((data) =>
      SyntheticLockupsByLockupIDResponse.decode(new Reader(data))
    );
  }
  ...
  AccountLockedLongerDurationNotUnlockingOnly(
    ...
    const data = AccountLockedLongerDurationNotUnlockingOnlyRequest.encode(
      request
    ).finish();
    const promise = this.rpc.request(
      "oppyfinance.oppychain.lockup.Query",
  ...
  AccountLockedLongerDurationDenom(
    ...
    const data = AccountLockedLongerDurationDenomRequest.encode(
      request
    ).finish();
    const promise = this.rpc.request(
      "oppyfinance.oppychain.lockup.Query",
    ...
    return promise.then((data) =>
      AccountLockedLongerDurationDenomResponse.decode(new Reader(data))
    );
  }
}
