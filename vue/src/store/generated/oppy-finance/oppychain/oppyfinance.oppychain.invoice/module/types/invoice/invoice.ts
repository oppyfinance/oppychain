...
export const InvoiceBase = {
  ...
  toJSON(message: InvoiceBase): unknown {
    ...
    message.origOwner !== undefined &&
      (obj.origOwner = base64FromBytes(
        message.origOwner !== undefined ? message.origOwner : new Uint8Array()
      ));
    return obj;
  },
...
export const InvoiceFinance = {
  ...
  toJSON(message: InvoiceFinance): unknown {
    ...
    message.amountLocked !== undefined &&
      (obj.amountLocked = base64FromBytes(
        message.amountLocked !== undefined
...
export const InvoiceMember = {
  ...
  toJSON(message: InvoiceMember): unknown {
    ...
    message.share !== undefined &&
      (obj.share = base64FromBytes(
        message.share !== undefined ? message.share : new Uint8Array()
      ));
    message.invoiceHolder !== undefined &&
      (obj.invoiceHolder = base64FromBytes(
        message.invoiceHolder !== undefined
          ? message.invoiceHolder
          : new Uint8Array()
      ));
    return obj;
  },
...
export const Invoice = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.invoiceFinance = InvoiceFinance.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          ...
          break;
        case 5:
          message.invoiceMembers.push(
            InvoiceMember.decode(reader, reader.uint32())
          );
          break;
        case 6:
  ...
  fromJSON(object: any): Invoice {
    ...
    if (
      object.isListedForSell !== undefined &&
      object.isListedForSell !== null
    ) {
  ...
  toJSON(message: Invoice): unknown {
    ...
    message.invoiceID !== undefined && (obj.invoiceID = message.invoiceID);
    message.invoiceBase !== undefined &&
      (obj.invoiceBase = message.invoiceBase
        ? InvoiceBase.toJSON(message.invoiceBase)
        : undefined);
    message.invoiceFinance !== undefined &&
      (obj.invoiceFinance = message.invoiceFinance
        ? InvoiceFinance.toJSON(message.invoiceFinance)
        : undefined);
    message.currentOwner !== undefined &&
      (obj.currentOwner = base64FromBytes(
        message.currentOwner !== undefined
          ? message.currentOwner
          : new Uint8Array()
      ));
    if (message.invoiceMembers) {
      obj.invoiceMembers = message.invoiceMembers.map((e) =>
        e ? InvoiceMember.toJSON(e) : undefined
      );
    } else {
      obj.invoiceMembers = [];
    }
    ...
    message.isListedForSell !== undefined &&
      (obj.isListedForSell = message.isListedForSell);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Invoice>): Invoice {
    ...
    if (object.invoiceFinance !== undefined && object.invoiceFinance !== null) {
      message.invoiceFinance = InvoiceFinance.fromPartial(
