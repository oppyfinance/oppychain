...
export const PlaceOrder = {
  ...
  fromJSON(object: any): PlaceOrder {
    ...
    if (
      object.placeOrderIndex !== undefined &&
      object.placeOrderIndex !== null
    ) {
  ...
  toJSON(message: PlaceOrder): unknown {
    ...
    message.placeOrderIndex !== undefined &&
      (obj.placeOrderIndex = message.placeOrderIndex);
