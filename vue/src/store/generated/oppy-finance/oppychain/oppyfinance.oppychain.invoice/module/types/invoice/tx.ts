...
export const MsgCreatePlaceOrderResponse = {
  encode(
    message: MsgCreatePlaceOrderResponse,
    writer: Writer = Writer.create()
  ): Writer {
  ...
  decode(
    ...
    length?: number
  ): MsgCreatePlaceOrderResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreatePlaceOrderResponse,
    } as MsgCreatePlaceOrderResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: MsgCreatePlaceOrderResponse): unknown {
    const obj: any = {};
    message.placeOrderID !== undefined &&
      (obj.placeOrderID = message.placeOrderID);
    return obj;
  },

  fromPartial(
    object: DeepPartial<MsgCreatePlaceOrderResponse>
  ): MsgCreatePlaceOrderResponse {
    const message = {
      ...baseMsgCreatePlaceOrderResponse,
    } as MsgCreatePlaceOrderResponse;
...
export const MsgCreateSellOrder = {
  ...
  toJSON(message: MsgCreateSellOrder): unknown {
    ...
    message.sellInvoiceID !== undefined &&
      (obj.sellInvoiceID = message.sellInvoiceID);
    message.amount !== undefined &&
      (obj.amount = base64FromBytes(
        message.amount !== undefined ? message.amount : new Uint8Array()
      ));
...
export const MsgCreateSellOrderResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgCreateSellOrderResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateSellOrderResponse,
    } as MsgCreateSellOrderResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateSellOrderResponse>
  ): MsgCreateSellOrderResponse {
    const message = {
      ...baseMsgCreateSellOrderResponse,
    } as MsgCreateSellOrderResponse;
...
export const MsgDeleteSellOrderResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgDeleteSellOrderResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgDeleteSellOrderResponse,
    } as MsgDeleteSellOrderResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgDeleteSellOrderResponse>
  ): MsgDeleteSellOrderResponse {
    const message = {
      ...baseMsgDeleteSellOrderResponse,
    } as MsgDeleteSellOrderResponse;
...
export const MsgCreateInvoice = {
  ...
  toJSON(message: MsgCreateInvoice): unknown {
    ...
    message.isRootOwner !== undefined &&
      (obj.isRootOwner = message.isRootOwner);
    return obj;
  },
...
export const MsgCreateInvoiceResponse = {
  ...
  fromPartial(
    object: DeepPartial<MsgCreateInvoiceResponse>
  ): MsgCreateInvoiceResponse {
    const message = {
      ...baseMsgCreateInvoiceResponse,
    } as MsgCreateInvoiceResponse;
...
export interface Msg {
  ...
  CreatePlaceOrder(
    request: MsgCreatePlaceOrder
  ): Promise<MsgCreatePlaceOrderResponse>;
  CreateSellOrder(
    request: MsgCreateSellOrder
  ): Promise<MsgCreateSellOrderResponse>;
  DeleteSellOrder(
    request: MsgDeleteSellOrder
  ): Promise<MsgDeleteSellOrderResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  CreatePlaceOrder(
    ...
    const promise = this.rpc.request(
      "oppyfinance.oppychain.invoice.Msg",
      "CreatePlaceOrder",
      data
    );
    return promise.then((data) =>
      MsgCreatePlaceOrderResponse.decode(new Reader(data))
    );
  }
  ...
  CreateSellOrder(
    ...
    return promise.then((data) =>
      MsgCreateSellOrderResponse.decode(new Reader(data))
    );
  }
  ...
  DeleteSellOrder(
    ...
    return promise.then((data) =>
      MsgDeleteSellOrderResponse.decode(new Reader(data))
    );
  }
