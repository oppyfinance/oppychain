...
export const QueryGetPlaceOrderRequest = {
  ...
  decode(
    ...
    length?: number
  ): QueryGetPlaceOrderRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPlaceOrderRequest,
    } as QueryGetPlaceOrderRequest;
  ...
  fromPartial(
    object: DeepPartial<QueryGetPlaceOrderRequest>
  ): QueryGetPlaceOrderRequest {
    const message = {
      ...baseQueryGetPlaceOrderRequest,
    } as QueryGetPlaceOrderRequest;
...
export const QueryGetPlaceOrderResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetPlaceOrderResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetPlaceOrderResponse,
    } as QueryGetPlaceOrderResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetPlaceOrderResponse): unknown {
    const obj: any = {};
    message.PlaceOrder !== undefined &&
      (obj.PlaceOrder = message.PlaceOrder
        ? PlaceOrder.toJSON(message.PlaceOrder)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetPlaceOrderResponse>
  ): QueryGetPlaceOrderResponse {
    const message = {
      ...baseQueryGetPlaceOrderResponse,
    } as QueryGetPlaceOrderResponse;
...
export const QueryAllPlaceOrderRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllPlaceOrderRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPlaceOrderRequest,
    } as QueryAllPlaceOrderRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllPlaceOrderRequest>
  ): QueryAllPlaceOrderRequest {
    const message = {
      ...baseQueryAllPlaceOrderRequest,
    } as QueryAllPlaceOrderRequest;
...
export const QueryAllPlaceOrderResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllPlaceOrderResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllPlaceOrderResponse,
    } as QueryAllPlaceOrderResponse;
    message.PlaceOrder = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: QueryAllPlaceOrderResponse): unknown {
    ...
    if (message.PlaceOrder) {
      obj.PlaceOrder = message.PlaceOrder.map((e) =>
        e ? PlaceOrder.toJSON(e) : undefined
      );
    } else {
      obj.PlaceOrder = [];
    }
  ...
  fromPartial(
    object: DeepPartial<QueryAllPlaceOrderResponse>
  ): QueryAllPlaceOrderResponse {
    const message = {
      ...baseQueryAllPlaceOrderResponse,
    } as QueryAllPlaceOrderResponse;
...
export interface Query {
  ...
  PlaceOrder(
    request: QueryGetPlaceOrderRequest
  ): Promise<QueryGetPlaceOrderResponse>;
  /** Queries a list of placeOrder items. */
  PlaceOrderAll(
    request: QueryAllPlaceOrderRequest
  ): Promise<QueryAllPlaceOrderResponse>;
...
export class QueryClientImpl implements Query {
  ...
  PlaceOrder(
    ...
    const promise = this.rpc.request(
      "oppyfinance.oppychain.invoice.Query",
      "PlaceOrder",
      data
    );
    return promise.then((data) =>
      QueryGetPlaceOrderResponse.decode(new Reader(data))
    );
  }
  ...
  PlaceOrderAll(
    ...
    return promise.then((data) =>
      QueryAllPlaceOrderResponse.decode(new Reader(data))
    );
  }
