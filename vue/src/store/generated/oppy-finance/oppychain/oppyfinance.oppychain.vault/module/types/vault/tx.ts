...
const baseMsgCreateOutboundTx: object = {
  requestID: "",
  outboundTx: "",
  blockHeight: "",
};
...
export const MsgCreateOutboundTxResponse = {
  encode(
    message: MsgCreateOutboundTxResponse,
    writer: Writer = Writer.create()
  ): Writer {
  ...
  decode(
    ...
    length?: number
  ): MsgCreateOutboundTxResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateOutboundTxResponse,
    } as MsgCreateOutboundTxResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateOutboundTxResponse>
  ): MsgCreateOutboundTxResponse {
    const message = {
      ...baseMsgCreateOutboundTxResponse,
    } as MsgCreateOutboundTxResponse;
...
export const MsgCreateIssueTokenResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateIssueTokenResponse,
    } as MsgCreateIssueTokenResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateIssueTokenResponse>
  ): MsgCreateIssueTokenResponse {
    const message = {
      ...baseMsgCreateIssueTokenResponse,
    } as MsgCreateIssueTokenResponse;
...
export const MsgCreateCreatePoolResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgCreateCreatePoolResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateCreatePoolResponse,
    } as MsgCreateCreatePoolResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateCreatePoolResponse>
  ): MsgCreateCreatePoolResponse {
    const message = {
      ...baseMsgCreateCreatePoolResponse,
    } as MsgCreateCreatePoolResponse;
...
export interface Msg {
  CreateOutboundTx(
    request: MsgCreateOutboundTx
  ): Promise<MsgCreateOutboundTxResponse>;
  /** this line is used by starport scaffolding # proto/tx/rpc */
  CreateIssueToken(
    request: MsgCreateIssueToken
  ): Promise<MsgCreateIssueTokenResponse>;
  CreateCreatePool(
    request: MsgCreateCreatePool
  ): Promise<MsgCreateCreatePoolResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreateOutboundTx(
    ...
    const promise = this.rpc.request(
      "oppyfinance.oppychain.vault.Msg",
      "CreateOutboundTx",
      data
    );
    return promise.then((data) =>
      MsgCreateOutboundTxResponse.decode(new Reader(data))
    );
  }
  ...
  CreateIssueToken(
    ...
    return promise.then((data) =>
      MsgCreateIssueTokenResponse.decode(new Reader(data))
    );
  }
  ...
  CreateCreatePool(
    ...
    return promise.then((data) =>
      MsgCreateCreatePoolResponse.decode(new Reader(data))
    );
  }
}
