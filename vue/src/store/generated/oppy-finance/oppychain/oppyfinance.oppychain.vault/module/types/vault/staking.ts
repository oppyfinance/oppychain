...
export const Params = {
  ...
  fromJSON(object: any): Params {
    ...
    if (
      object.candidate_ratio !== undefined &&
      object.candidate_ratio !== null
    ) {
  ...
  toJSON(message: Params): unknown {
    const obj: any = {};
    message.block_churn_interval !== undefined &&
      (obj.block_churn_interval = message.block_churn_interval);
