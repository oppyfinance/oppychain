...
export const QueryGetOutboundTxRequest = {
  ...
  decode(
    ...
    length?: number
  ): QueryGetOutboundTxRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetOutboundTxRequest,
    } as QueryGetOutboundTxRequest;
  ...
  fromPartial(
    object: DeepPartial<QueryGetOutboundTxRequest>
  ): QueryGetOutboundTxRequest {
    const message = {
      ...baseQueryGetOutboundTxRequest,
    } as QueryGetOutboundTxRequest;
...
export const QueryGetOutboundTxResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetOutboundTxResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetOutboundTxResponse,
    } as QueryGetOutboundTxResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetOutboundTxResponse): unknown {
    const obj: any = {};
    message.outboundTx !== undefined &&
      (obj.outboundTx = message.outboundTx
        ? OutboundTx.toJSON(message.outboundTx)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetOutboundTxResponse>
  ): QueryGetOutboundTxResponse {
    const message = {
      ...baseQueryGetOutboundTxResponse,
    } as QueryGetOutboundTxResponse;
...
export const QueryAllOutboundTxRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllOutboundTxRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllOutboundTxRequest,
    } as QueryAllOutboundTxRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllOutboundTxRequest>
  ): QueryAllOutboundTxRequest {
    const message = {
      ...baseQueryAllOutboundTxRequest,
    } as QueryAllOutboundTxRequest;
...
export const QueryAllOutboundTxResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllOutboundTxResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllOutboundTxResponse,
    } as QueryAllOutboundTxResponse;
    message.outboundTx = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<QueryAllOutboundTxResponse>
  ): QueryAllOutboundTxResponse {
    const message = {
      ...baseQueryAllOutboundTxResponse,
    } as QueryAllOutboundTxResponse;
...
export const QueryGetValidatorsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetValidatorsRequest,
    } as QueryGetValidatorsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetValidatorsRequest>
  ): QueryGetValidatorsRequest {
    const message = {
      ...baseQueryGetValidatorsRequest,
    } as QueryGetValidatorsRequest;
...
export const QueryGetValidatorsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetValidatorsResponse,
    } as QueryGetValidatorsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetValidatorsResponse): unknown {
    ...
    message.validators !== undefined &&
      (obj.validators = message.validators
        ? Validators.toJSON(message.validators)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetValidatorsResponse>
  ): QueryGetValidatorsResponse {
    const message = {
      ...baseQueryGetValidatorsResponse,
    } as QueryGetValidatorsResponse;
...
const baseQueryAllValidatorsRequest: object = {};
...
export const QueryAllValidatorsRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllValidatorsRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllValidatorsRequest,
    } as QueryAllValidatorsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllValidatorsRequest>
  ): QueryAllValidatorsRequest {
    const message = {
      ...baseQueryAllValidatorsRequest,
    } as QueryAllValidatorsRequest;
...
const baseQueryAllValidatorsResponse: object = {};
...
export const QueryAllValidatorsResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllValidatorsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllValidatorsResponse,
    } as QueryAllValidatorsResponse;
    message.all_validators = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.all_validators.push(
  ...
  toJSON(message: QueryAllValidatorsResponse): unknown {
    ...
    if (message.all_validators) {
      obj.all_validators = message.all_validators.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryAllValidatorsResponse>
  ): QueryAllValidatorsResponse {
    const message = {
      ...baseQueryAllValidatorsResponse,
    } as QueryAllValidatorsResponse;
...
export const QueryGetIssueTokenRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetIssueTokenRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetIssueTokenRequest,
    } as QueryGetIssueTokenRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetIssueTokenRequest>
  ): QueryGetIssueTokenRequest {
    const message = {
      ...baseQueryGetIssueTokenRequest,
    } as QueryGetIssueTokenRequest;
...
export const QueryGetIssueTokenResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetIssueTokenResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetIssueTokenResponse,
    } as QueryGetIssueTokenResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetIssueTokenResponse): unknown {
    const obj: any = {};
    message.IssueToken !== undefined &&
      (obj.IssueToken = message.IssueToken
        ? IssueToken.toJSON(message.IssueToken)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetIssueTokenResponse>
  ): QueryGetIssueTokenResponse {
    const message = {
      ...baseQueryGetIssueTokenResponse,
    } as QueryGetIssueTokenResponse;
...
export const QueryAllIssueTokenRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllIssueTokenRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllIssueTokenRequest,
    } as QueryAllIssueTokenRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllIssueTokenRequest>
  ): QueryAllIssueTokenRequest {
    const message = {
      ...baseQueryAllIssueTokenRequest,
    } as QueryAllIssueTokenRequest;
...
export const QueryAllIssueTokenResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllIssueTokenResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllIssueTokenResponse,
    } as QueryAllIssueTokenResponse;
    message.IssueToken = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: QueryAllIssueTokenResponse): unknown {
    ...
    if (message.IssueToken) {
      obj.IssueToken = message.IssueToken.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryAllIssueTokenResponse>
  ): QueryAllIssueTokenResponse {
    const message = {
      ...baseQueryAllIssueTokenResponse,
    } as QueryAllIssueTokenResponse;
...
export const QueryGetCreatePoolRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetCreatePoolRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetCreatePoolRequest,
    } as QueryGetCreatePoolRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGetCreatePoolRequest>
  ): QueryGetCreatePoolRequest {
    const message = {
      ...baseQueryGetCreatePoolRequest,
    } as QueryGetCreatePoolRequest;
...
export const QueryGetCreatePoolResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryGetCreatePoolResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGetCreatePoolResponse,
    } as QueryGetCreatePoolResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: QueryGetCreatePoolResponse): unknown {
    const obj: any = {};
    message.CreatePool !== undefined &&
      (obj.CreatePool = message.CreatePool
        ? PoolProposal.toJSON(message.CreatePool)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryGetCreatePoolResponse>
  ): QueryGetCreatePoolResponse {
    const message = {
      ...baseQueryGetCreatePoolResponse,
    } as QueryGetCreatePoolResponse;
...
export const QueryLastPoolResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryLastPoolResponse>
  ): QueryLastPoolResponse {
    const message = { ...baseQueryLastPoolResponse } as QueryLastPoolResponse;
    message.pools = [];
    if (object.pools !== undefined && object.pools !== null) {
      for (const e of object.pools) {
...
export const QueryAllCreatePoolRequest = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllCreatePoolRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllCreatePoolRequest,
    } as QueryAllCreatePoolRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryAllCreatePoolRequest>
  ): QueryAllCreatePoolRequest {
    const message = {
      ...baseQueryAllCreatePoolRequest,
    } as QueryAllCreatePoolRequest;
...
export const QueryLatestPoolRequest = {
  ...
  fromPartial(
    object: DeepPartial<QueryLatestPoolRequest>
...
export const QueryAllCreatePoolResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): QueryAllCreatePoolResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryAllCreatePoolResponse,
    } as QueryAllCreatePoolResponse;
    message.CreatePool = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: QueryAllCreatePoolResponse): unknown {
    ...
    if (message.CreatePool) {
      obj.CreatePool = message.CreatePool.map((e) =>
        e ? PoolProposal.toJSON(e) : undefined
      );
    } else {
      obj.CreatePool = [];
    }
  ...
  fromPartial(
    object: DeepPartial<QueryAllCreatePoolResponse>
  ): QueryAllCreatePoolResponse {
    const message = {
      ...baseQueryAllCreatePoolResponse,
    } as QueryAllCreatePoolResponse;
...
export interface Query {
  ...
  OutboundTx(
    request: QueryGetOutboundTxRequest
  ): Promise<QueryGetOutboundTxResponse>;
  /** Queries a list of OutboundTx items. */
  OutboundTxAll(
    request: QueryAllOutboundTxRequest
  ...
  ): Promise<QueryGetIssueTokenResponse>;
  /** Queries a list of issueToken items. */
  IssueTokenAll(
    request: QueryAllIssueTokenRequest
  ): Promise<QueryAllIssueTokenResponse>;
  /** Queries a createPool by index. */
  CreatePool(
    request: QueryGetCreatePoolRequest
  ): Promise<QueryGetCreatePoolResponse>;
  /** Queries a list of createPool items. */
  CreatePoolAll(
    request: QueryAllCreatePoolRequest
...
export class QueryClientImpl implements Query {
  ...
  OutboundTx(
    ...
    return promise.then((data) =>
      QueryGetOutboundTxResponse.decode(new Reader(data))
    );
  }
  ...
  OutboundTxAll(
    ...
    return promise.then((data) =>
      QueryAllOutboundTxResponse.decode(new Reader(data))
    );
  }
  ...
  GetValidators(
    ...
    return promise.then((data) =>
      QueryGetValidatorsResponse.decode(new Reader(data))
    );
  }
  ...
  IssueToken(
    ...
    return promise.then((data) =>
      QueryGetIssueTokenResponse.decode(new Reader(data))
    );
  }
  ...
  IssueTokenAll(
    ...
    return promise.then((data) =>
      QueryAllIssueTokenResponse.decode(new Reader(data))
    );
  }
  ...
  CreatePool(
    ...
    return promise.then((data) =>
      QueryGetCreatePoolResponse.decode(new Reader(data))
    );
  }
  ...
  CreatePoolAll(
    ...
    return promise.then((data) =>
      QueryAllCreatePoolResponse.decode(new Reader(data))
    );
  }
