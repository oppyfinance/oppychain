...
const baseMsgCreateGauge: object = {
  is_perpetual: false,
  owner: "",
...
export class MsgClientImpl implements Msg {
  ...
  CreateGauge(request: MsgCreateGauge): Promise<MsgCreateGaugeResponse> {
    ...
    const promise = this.rpc.request(
      "oppyfinance.oppychain.incentives.Msg",
      "CreateGauge",
      data
    );
    return promise.then((data) =>
      MsgCreateGaugeResponse.decode(new Reader(data))
    );
  }
  ...
  AddToGauge(request: MsgAddToGauge): Promise<MsgAddToGaugeResponse> {
    ...
    return promise.then((data) =>
      MsgAddToGaugeResponse.decode(new Reader(data))
    );
  }
}
