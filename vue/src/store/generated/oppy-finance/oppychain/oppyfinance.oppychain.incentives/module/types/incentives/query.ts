...
export const ModuleToDistributeCoinsRequest = {
  ...
  decode(
    ...
    const message = {
      ...baseModuleToDistributeCoinsRequest,
    } as ModuleToDistributeCoinsRequest;
  ...
  fromPartial(
    _: DeepPartial<ModuleToDistributeCoinsRequest>
  ): ModuleToDistributeCoinsRequest {
    const message = {
      ...baseModuleToDistributeCoinsRequest,
    } as ModuleToDistributeCoinsRequest;
...
export const ModuleToDistributeCoinsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseModuleToDistributeCoinsResponse,
    } as ModuleToDistributeCoinsResponse;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<ModuleToDistributeCoinsResponse>
  ): ModuleToDistributeCoinsResponse {
    const message = {
      ...baseModuleToDistributeCoinsResponse,
    } as ModuleToDistributeCoinsResponse;
...
export const ModuleDistributedCoinsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseModuleDistributedCoinsRequest,
    } as ModuleDistributedCoinsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<ModuleDistributedCoinsRequest>
  ): ModuleDistributedCoinsRequest {
    const message = {
      ...baseModuleDistributedCoinsRequest,
    } as ModuleDistributedCoinsRequest;
...
export const ModuleDistributedCoinsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseModuleDistributedCoinsResponse,
    } as ModuleDistributedCoinsResponse;
    message.coins = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<ModuleDistributedCoinsResponse>
  ): ModuleDistributedCoinsResponse {
    const message = {
      ...baseModuleDistributedCoinsResponse,
    } as ModuleDistributedCoinsResponse;
...
export const ActiveGaugesPerDenomRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseActiveGaugesPerDenomRequest,
    } as ActiveGaugesPerDenomRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<ActiveGaugesPerDenomRequest>
  ): ActiveGaugesPerDenomRequest {
    const message = {
      ...baseActiveGaugesPerDenomRequest,
    } as ActiveGaugesPerDenomRequest;
...
export const ActiveGaugesPerDenomResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseActiveGaugesPerDenomResponse,
    } as ActiveGaugesPerDenomResponse;
    message.data = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<ActiveGaugesPerDenomResponse>
  ): ActiveGaugesPerDenomResponse {
    const message = {
      ...baseActiveGaugesPerDenomResponse,
    } as ActiveGaugesPerDenomResponse;
...
export const UpcomingGaugesRequest = {
  ...
  fromPartial(
    object: DeepPartial<UpcomingGaugesRequest>
...
export const UpcomingGaugesResponse = {
  ...
  fromPartial(
    object: DeepPartial<UpcomingGaugesResponse>
...
export const UpcomingGaugesPerDenomRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpcomingGaugesPerDenomRequest,
    } as UpcomingGaugesPerDenomRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<UpcomingGaugesPerDenomRequest>
  ): UpcomingGaugesPerDenomRequest {
    const message = {
      ...baseUpcomingGaugesPerDenomRequest,
    } as UpcomingGaugesPerDenomRequest;
...
export const UpcomingGaugesPerDenomResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseUpcomingGaugesPerDenomResponse,
    } as UpcomingGaugesPerDenomResponse;
  ...
  fromJSON(object: any): UpcomingGaugesPerDenomResponse {
    ...
    message.upcoming_gauges = [];
    if (
      object.upcoming_gauges !== undefined &&
      object.upcoming_gauges !== null
    ) {
  ...
  toJSON(message: UpcomingGaugesPerDenomResponse): unknown {
    ...
    if (message.upcoming_gauges) {
      obj.upcoming_gauges = message.upcoming_gauges.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<UpcomingGaugesPerDenomResponse>
  ): UpcomingGaugesPerDenomResponse {
    const message = {
      ...baseUpcomingGaugesPerDenomResponse,
    } as UpcomingGaugesPerDenomResponse;
...
export class QueryClientImpl implements Query {
  ...
  ModuleToDistributeCoins(
    ...
    const promise = this.rpc.request(
      "oppyfinance.oppychain.incentives.Query",
      "ModuleToDistributeCoins",
      data
    );
    return promise.then((data) =>
      ModuleToDistributeCoinsResponse.decode(new Reader(data))
    );
  }
  ...
  ModuleDistributedCoins(
    ...
    return promise.then((data) =>
      ModuleDistributedCoinsResponse.decode(new Reader(data))
    );
  }
  ...
  ActiveGauges(request: ActiveGaugesRequest): Promise<ActiveGaugesResponse> {
    ...
    return promise.then((data) =>
      ActiveGaugesResponse.decode(new Reader(data))
    );
  }
  ...
  ActiveGaugesPerDenom(
    ...
    return promise.then((data) =>
      ActiveGaugesPerDenomResponse.decode(new Reader(data))
    );
  }
  ...
  UpcomingGauges(
    ...
    return promise.then((data) =>
      UpcomingGaugesResponse.decode(new Reader(data))
    );
  }
  ...
  UpcomingGaugesPerDenom(
    ...
    return promise.then((data) =>
      UpcomingGaugesPerDenomResponse.decode(new Reader(data))
    );
  }
