...
export const QueryGaugeIdsResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGaugeIdsResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.gauge_ids_with_duration.push(
  ...
  fromJSON(object: any): QueryGaugeIdsResponse {
    ...
    message.gauge_ids_with_duration = [];
    if (
      object.gauge_ids_with_duration !== undefined &&
      object.gauge_ids_with_duration !== null
    ) {
  ...
  toJSON(message: QueryGaugeIdsResponse): unknown {
    ...
    if (message.gauge_ids_with_duration) {
      obj.gauge_ids_with_duration = message.gauge_ids_with_duration.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryGaugeIdsResponse>
...
export const QueryGaugeIdsResponse_GaugeIdWithDuration = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryGaugeIdsResponse_GaugeIdWithDuration,
    } as QueryGaugeIdsResponse_GaugeIdWithDuration;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<QueryGaugeIdsResponse_GaugeIdWithDuration>
  ): QueryGaugeIdsResponse_GaugeIdWithDuration {
    const message = {
      ...baseQueryGaugeIdsResponse_GaugeIdWithDuration,
    } as QueryGaugeIdsResponse_GaugeIdWithDuration;
...
export const QueryDistrInfoResponse = {
  ...
  toJSON(message: QueryDistrInfoResponse): unknown {
    const obj: any = {};
    message.distr_info !== undefined &&
      (obj.distr_info = message.distr_info
        ? DistrInfo.toJSON(message.distr_info)
        : undefined);
    return obj;
  },

  fromPartial(
    object: DeepPartial<QueryDistrInfoResponse>
...
export const QueryLockableDurationsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryLockableDurationsRequest,
    } as QueryLockableDurationsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<QueryLockableDurationsRequest>
  ): QueryLockableDurationsRequest {
    const message = {
      ...baseQueryLockableDurationsRequest,
    } as QueryLockableDurationsRequest;
...
export const QueryLockableDurationsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryLockableDurationsResponse,
    } as QueryLockableDurationsResponse;
    message.lockable_durations = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.lockable_durations.push(
  ...
  fromJSON(object: any): QueryLockableDurationsResponse {
    ...
    message.lockable_durations = [];
    if (
      object.lockable_durations !== undefined &&
      object.lockable_durations !== null
    ) {
  ...
  toJSON(message: QueryLockableDurationsResponse): unknown {
    ...
    if (message.lockable_durations) {
      obj.lockable_durations = message.lockable_durations.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryLockableDurationsResponse>
  ): QueryLockableDurationsResponse {
    const message = {
      ...baseQueryLockableDurationsResponse,
    } as QueryLockableDurationsResponse;
...
export const QueryIncentivizedPoolsRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryIncentivizedPoolsRequest,
    } as QueryIncentivizedPoolsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<QueryIncentivizedPoolsRequest>
  ): QueryIncentivizedPoolsRequest {
    const message = {
      ...baseQueryIncentivizedPoolsRequest,
    } as QueryIncentivizedPoolsRequest;
...
export const IncentivizedPool = {
  ...
  toJSON(message: IncentivizedPool): unknown {
    ...
    message.pool_id !== undefined && (obj.pool_id = message.pool_id);
    message.lockable_duration !== undefined &&
      (obj.lockable_duration = message.lockable_duration
        ? Duration.toJSON(message.lockable_duration)
        : undefined);
    message.gauge_id !== undefined && (obj.gauge_id = message.gauge_id);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<IncentivizedPool>): IncentivizedPool {
    ...
    if (
      ...
      message.lockable_duration = Duration.fromPartial(
        object.lockable_duration
      );
    } else {
      message.lockable_duration = undefined;
    }
...
export const QueryIncentivizedPoolsResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryIncentivizedPoolsResponse,
    } as QueryIncentivizedPoolsResponse;
    message.incentivized_pools = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.incentivized_pools.push(
  ...
  fromJSON(object: any): QueryIncentivizedPoolsResponse {
    ...
    message.incentivized_pools = [];
    if (
      object.incentivized_pools !== undefined &&
      object.incentivized_pools !== null
    ) {
  ...
  toJSON(message: QueryIncentivizedPoolsResponse): unknown {
    ...
    if (message.incentivized_pools) {
      obj.incentivized_pools = message.incentivized_pools.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryIncentivizedPoolsResponse>
  ): QueryIncentivizedPoolsResponse {
    const message = {
      ...baseQueryIncentivizedPoolsResponse,
    } as QueryIncentivizedPoolsResponse;
...
export const QueryExternalIncentiveGaugesRequest = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryExternalIncentiveGaugesRequest,
    } as QueryExternalIncentiveGaugesRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<QueryExternalIncentiveGaugesRequest>
  ): QueryExternalIncentiveGaugesRequest {
    const message = {
      ...baseQueryExternalIncentiveGaugesRequest,
    } as QueryExternalIncentiveGaugesRequest;
...
export const QueryExternalIncentiveGaugesResponse = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseQueryExternalIncentiveGaugesResponse,
    } as QueryExternalIncentiveGaugesResponse;
    message.data = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<QueryExternalIncentiveGaugesResponse>
  ): QueryExternalIncentiveGaugesResponse {
    const message = {
      ...baseQueryExternalIncentiveGaugesResponse,
    } as QueryExternalIncentiveGaugesResponse;
...
export class QueryClientImpl implements Query {
  ...
  GaugeIds(request: QueryGaugeIdsRequest): Promise<QueryGaugeIdsResponse> {
    ...
    return promise.then((data) =>
      QueryGaugeIdsResponse.decode(new Reader(data))
    );
  }
  ...
  DistrInfo(request: QueryDistrInfoRequest): Promise<QueryDistrInfoResponse> {
    ...
    return promise.then((data) =>
      QueryDistrInfoResponse.decode(new Reader(data))
    );
  }
  ...
  LockableDurations(
    ...
    return promise.then((data) =>
      QueryLockableDurationsResponse.decode(new Reader(data))
    );
  }
  ...
  IncentivizedPools(
    ...
    return promise.then((data) =>
      QueryIncentivizedPoolsResponse.decode(new Reader(data))
    );
  }
  ...
  ExternalIncentiveGauges(
    ...
    return promise.then((data) =>
      QueryExternalIncentiveGaugesResponse.decode(new Reader(data))
    );
  }
}
