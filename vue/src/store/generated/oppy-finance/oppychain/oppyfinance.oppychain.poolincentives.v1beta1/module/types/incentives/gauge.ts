...
export const Gauge = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.distribute_to = QueryCondition.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): Gauge {
    ...
    if (
      object.distributed_coins !== undefined &&
      object.distributed_coins !== null
    ) {
  ...
  toJSON(message: Gauge): unknown {
    ...
    message.is_perpetual !== undefined &&
      (obj.is_perpetual = message.is_perpetual);
    message.distribute_to !== undefined &&
      (obj.distribute_to = message.distribute_to
        ? QueryCondition.toJSON(message.distribute_to)
        : undefined);
    if (message.coins) {
    ...
    message.start_time !== undefined &&
      (obj.start_time =
        message.start_time !== undefined
          ...
          : null);
    message.num_epochs_paid_over !== undefined &&
      (obj.num_epochs_paid_over = message.num_epochs_paid_over);
    message.filled_epochs !== undefined &&
      (obj.filled_epochs = message.filled_epochs);
    if (message.distributed_coins) {
      obj.distributed_coins = message.distributed_coins.map((e) =>
