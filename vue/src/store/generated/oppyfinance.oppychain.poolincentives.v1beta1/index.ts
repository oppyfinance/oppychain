...
import { ReplacePoolIncentivesProposal } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
import { UpdatePoolIncentivesProposal } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
import { Params } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
import { LockableDurationsInfo } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
import { DistrInfo } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
import { DistrRecord } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
import { QueryGaugeIdsResponse_GaugeIdWithDuration } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
import { IncentivizedPool } from "oppy-finance-oppychain-client-ts/oppyfinance.oppychain.poolincentives.v1beta1/types"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: oppyfinance.oppychain.poolincentives.v1beta1 initialized!')
		...
		async QueryGaugeIds({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				let value= (await client.OppyfinanceOppychainPoolincentivesV1Beta1.query.queryGaugeIds( key.pool_id)).data
		...
		async QueryDistrInfo({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainPoolincentivesV1Beta1.query.queryDistrInfo()).data
		...
		async QueryParams({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainPoolincentivesV1Beta1.query.queryParams()).data
		...
		async QueryLockableDurations({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainPoolincentivesV1Beta1.query.queryLockableDurations()).data
		...
		async QueryIncentivizedPools({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainPoolincentivesV1Beta1.query.queryIncentivizedPools()).data
		...
		async QueryExternalIncentiveGauges({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.OppyfinanceOppychainPoolincentivesV1Beta1.query.queryExternalIncentiveGauges()).data
