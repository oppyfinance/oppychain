...
import { WeightedVoteOption } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "oppy-finance-oppychain-client-ts/cosmos.gov.v1beta1/types"
